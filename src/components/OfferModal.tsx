...
const MODAL_DURATION = 15; // seconds
    ...
    <AnimatePresence>
      {open && (
        <motion.div className="fixed inset-0 z-[1000] flex items-center justify-center">
          ...
          >
            <source src="public\IMG_8866.MOV" type="video/mp4" />
          ...
          >
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              />
              <h2
                className="text-brand-maroon font-bold text-2xl md:text-3xl mb-2 mt-2 text-center tracking-tight"
              ...
              <button
                onClick={() => {
                  setModalSessionSeen();
                  navigate("/offers"); // ✅ Route to offer page
                }}
